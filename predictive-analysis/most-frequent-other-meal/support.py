...
df["Menu_Item"] = df["What other meal/s you usually order from McDonalds?"].apply(lambda x: x.split(", ") if pd.notna(x) else ["None"])
...
# Display Results
print(f"\n **Most Frequently Ordered Other Meal:** {most_frequent_menu_item} ({most_frequent_menu_count} orders)\n")
